...
Below histogram shows total number of steps taken each day.
```{r}
library(ggplot2)
...
Time series plot has 5-minute interval (x-axis) and the average number of steps taken, averaged across all days (y-axis)
